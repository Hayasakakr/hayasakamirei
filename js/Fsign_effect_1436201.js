...
// stage content:
(lib.sign_effect_1436201 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_1436201_1();

	// image_replace
	this.instance = new lib.replace_image_1436201();
...
// symbols:
(lib.replace_image_1436201 = function() {
	this.initialize(img.replace_image_1436201);
...
(lib.reflect_mask_1436201 = function() {
	this.initialize();
...
(lib.reflect_wrapper_1436201 = function() {
	this.initialize();
