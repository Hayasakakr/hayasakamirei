...
// stage content:
(lib.sign_effect_62 = function() {
	this.initialize();

	// sign
	this.sign_effect = new lib.sign_effect_62_1();

	// image_replace
	this.instance = new lib.replace_image_62();

	this.addChild(this.instance,this.sign_effect);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-14.3,0,654.4,800);


// symbols:
(lib.replace_image_62 = function() {
	this.initialize(img.replace_image_62);
...
(lib.reflect_container_cjs_62 = function(mode,startPosition,loop) {
...
(lib.reflect_wrapper_62 = function() {
	this.initialize();

	// cjs
	this.reflect = new lib.reflect_container_cjs_62();
...
(lib.sign_effect_62_1 = function() {
	this.initialize();

	// glitter
	this.instance = new lib.glitter_wrapper();
	this.instance.setTransform(82,652);

	this.instance_1 = new lib.glitter_wrapper();
	this.instance_1.setTransform(65.8,588.8);

	this.instance_2 = new lib.glitter_wrapper();
	this.instance_2.setTransform(250.7,669.9);

	this.instance_3 = new lib.glitter_wrapper();
	this.instance_3.setTransform(181.6,660.5,0.725,0.725);

	this.instance_4 = new lib.glitter_wrapper();
	this.instance_4.setTransform(261.1,606.1,0.692,0.692);

	this.instance_5 = new lib.glitter_wrapper();
	this.instance_5.setTransform(22.7,664.2,0.66,0.66);

	this.instance_6 = new lib.glitter_wrapper();
	this.instance_6.setTransform(155.5,596.3);

	this.instance_7 = new lib.glitter_wrapper();
	this.instance_7.setTransform(344.6,575.8);

	// mask
	this.reflect_mask = new lib.reflect_mask_62();
	...
	// reflect
	this.reflect_wrapper = new lib.reflect_wrapper_62();
...
p.nominalBounds = new cjs.Rectangle(-14.3,256.5,415,734.1);
